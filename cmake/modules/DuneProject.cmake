...
set(${ProjectName}_DOXYGEN_DIR \"@DOXYGEN_DIR@\")
...
if(${ProjectName}_LIBRARIES AND NOT ${ProjectName}_IN_CONFIG_MODE)
  ...
  set(DOXYGEN_DIR "${CMAKE_INSTALL_DOCDIR}/doxygen")
  ...
  configure_package_config_file(${CONFIG_SOURCE_FILE}
    ...
    DOXYSTYLE_DIR DOXYGEN_DIR SCRIPT_DIR)

  get_property(DOXYGEN_DIR GLOBAL PROPERTY ${PROJECT_NAME}_DOXYGEN_DIR)

  set(PACKAGE_DOXYGEN_DIR ${DOXYGEN_DIR})
