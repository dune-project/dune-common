...
macro(dune_add_library basename)
  ...
  if(DUNE_LIB_OBJECT)
    ...
    if(DUNE_LIB_ADD_LIBS)
      dune_target_link_libraries(${basename} PUBLIC "${DUNE_LIB_ADD_LIBS}")
    endif()
    ...
    if(DUNE_BUILD_BOTH_LIBS)
      if(BUILD_SHARED_LIBS)
        ...
        # link with specified libraries.
        if(DUNE_LIB_ADD_LIBS)
          dune_target_link_libraries(${basename}-static PUBLIC "${DUNE_LIB_ADD_LIBS}")
        endif()
        if(DUNE_LIB_COMPILE_FLAGS)
        ...
        # link with specified libraries.
        if(DUNE_LIB_ADD_LIBS)
          dune_target_link_libraries(${basename}-shared PUBLIC "${DUNE_LIB_ADD_LIBS}")
        endif()
        if(DUNE_LIB_COMPILE_FLAGS)
