...
Find the parallel graph partitioning library
...
``ParMETIS::ParMETIS``
  ...
  encapsulating the include directories and link libraries needed to use
  ParMETIS.
...
``ParMETIS_FOUND``
  Boolean result indicating whether ParMETIS and its required dependencies
  were found.
