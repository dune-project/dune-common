...
{
  void static eigenvaluesSymmetric(FieldMatrix<K, n, n> const &matrix,
...
{
  template <typename C> // FIXME?
  void static eigenvaluesGeneric(FieldMatrix<K, n, n> const &matrix,
                                 FieldVector<C, n> &eigenvalues) {
    const long int N = n;
    const char jobvl = 'n';
    const char jobvr = 'n';
  ...
  namespace FMatrixHelp {
    ...
    */
    ...
    {
      int const dim = 1;
      Impl::DuneEigenvalueHelper<K, dim>::eigenvaluesSymmetric(matrix, eigenvalues);
    }
    ...
    */
    ...
    {
      Impl::LapackEigenvalueHelper<K, dim>::eigenvaluesSymmetric(matrix, eigenvalues);
    }
    ...
    {
      Impl::LapackEigenvalueHelper<K, dim>::eigenvaluesGeneric(matrix, eigenvalues);
    }
