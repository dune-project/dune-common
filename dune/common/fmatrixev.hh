...
extern "C" {
  ...
  extern void SSYEV_FORTRAN(const char* jobz, const char* uplo, const long int* n,
                            float* a, const long int* lda, float* w,
                            float* work, const long int* lwork, long int* info);

  // TODO: Document
  extern void CHEEV_FORTRAN(const char* jobz, const char* uplo, const long int* n,
                            std::complex<float>* a, const long int* lda,
                            float* w, std::complex<float>* work,
                            const long int* lwork, float *rwork, long int* info);
  extern void ZHEEV_FORTRAN(const char* jobz, const char* uplo, const long int* n,
  ...
  extern void SGEEV_FORTRAN(const char* jobvl, const char* jobvr, const long int* n,
                            float* a, const long int* lda, float* wr, float* wi, float* vl,
                            const long int* ldvl, float* vr, const long int* ldvr, float* work,
                            const long int* lwork, const long int* info);

  // TODO: Document
  extern void CGEEV_FORTRAN(const char* jobvl, const char* jobvr, const long int* n,
                            std::complex<float>* a, const long int* lda,
                            std::complex<float>* w, std::complex<float>* vl,
                            const long int* ldvl, std::complex<float>* vr,
                            const long int* ldvr, std::complex<float>* work,
                            const long int* lwork, float *rwork, const long int* info);
  extern void ZGEEV_FORTRAN(const char* jobvl, const char* jobvr, const long int* n,
                            std::complex<double>* a, const long int* lda,
                            std::complex<double>* w, std::complex<double>* vl,
                            const long int* ldvl, std::complex<double>* vr,
                            const long int* ldvr, std::complex<double>* work,
