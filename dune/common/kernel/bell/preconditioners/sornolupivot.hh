...
#ifndef DUNE_COMMON_KERNEL_BELL_PRECONDITIONERS_SORNOLUPIVOT_HH
#define DUNE_COMMON_KERNEL_BELL_PRECONDITIONERS_SORNOLUPIVOT_HH
    ...
    namespace bell {
      namespace preconditioners {
        ...
        namespace blocked {
          ...
          void sor_no_lu_pivot(T1* DUNE_RESTRICT v,
...
#define DECLARE_KERNEL(T1,T2,T3,I,alignment,kernel_block_size)          \
          template                                                      \
          void sor_no_lu_pivot<T1,T2,T3,I,alignment,kernel_block_size>( \
            T1* DUNE_RESTRICT v,                                        \
            const T2* DUNE_RESTRICT d,                                  \
            const T3* DUNE_RESTRICT diag_mat_data,                      \
            const T3* DUNE_RESTRICT mat_data,                           \
...
#endif // DUNE_COMMON_KERNEL_BELL_PRECONDITIONERS_SORREDNOLUPIVOT_HH
