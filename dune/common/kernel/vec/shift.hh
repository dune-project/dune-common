...
#ifndef DUNE_COMMON_KERNEL_VEC_SHIFT_HH
#define DUNE_COMMON_KERNEL_VEC_SHIFT_HH
...
#define DECLARE_KERNEL(T1,T2,I,alignment,block_size)                    \
        template                                                        \
        void shift<T1,T2,I,alignment,block_size>(                       \
          T1* DUNE_RESTRICT x,                                          \
          T2  alpha,                                                    \
          I n);
...
#endif // DUNE_COMMON_KERNEL_VEC_SHIFT_HH
