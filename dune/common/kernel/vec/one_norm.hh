...
#ifndef DUNE_COMMON_KERNEL_VEC_ONE_NORM_HH
#define DUNE_COMMON_KERNEL_VEC_ONE_NORM_HH
...
#define DECLARE_KERNEL(T1,I,alignment,block_size)                       \
        template                                                        \
        T1                                                              \
        one_norm<T1,I,alignment,block_size>(                            \
          T1* DUNE_RESTRICT x,                                          \
          I n);
...
#endif // DUNE_COMMON_KERNEL_VEC_ONE_NORM_HH
