...
#ifndef DUNE_COMMON_KERNEL_VEC_MUL_HH
#define DUNE_COMMON_KERNEL_VEC_MUL_HH
...
#define DECLARE_KERNEL(T1,T2,I,alignment,block_size)                    \
        template                                                        \
        void mul<T1,T2,I,alignment,block_size>(                         \
          T1* DUNE_RESTRICT x,                                          \
          T2* DUNE_RESTRICT y,                                          \
          I n);
...
#endif // DUNE_COMMON_KERNEL_VEC_MUL_HH
