...
#ifndef DUNE_COMMON_KERNEL_VEC_ADD_HH
#define DUNE_COMMON_KERNEL_VEC_ADD_HH
...
#define DECLARE_KERNEL(T1,T2,I,alignment,block_size)                    \
        template                                                        \
        void add<T1,T2,I,alignment,block_size>(                         \
          T1* DUNE_RESTRICT x,                                          \
          T2* DUNE_RESTRICT y,                                          \
          I n);
...
#endif // DUNE_COMMON_KERNEL_VEC_ADD_HH
