...
{
  static constexpr int value = Data::first_type::value;
  static constexpr bool isDivisor = (PotentialDivisor::value*(value / PotentialDivisor::value)==value);
...
{
  static constexpr bool isPrime = (Divisors<N::value>::value==2);
