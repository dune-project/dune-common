...
auto testSparseRange()
{
  ...
  checkWithMatrix(Dune::DiagonalMatrix<double,1>({42}));
  checkWithMatrix(Dune::DiagonalMatrix<double,2>({42, 41}));
  checkWithMatrix(Dune::DiagonalMatrix<double,3>({42, 41, 40}));
