...
namespace Dune
{
  ...
  */
  ...
  public:
    ...
    constexpr iterator begin() const noexcept { return iterator(from); }
    constexpr iterator end() const noexcept { return iterator(to); }
    ...
    constexpr size_type size() const noexcept { return (static_cast<size_type>(to) - static_cast<size_type>(from)); }
  };
