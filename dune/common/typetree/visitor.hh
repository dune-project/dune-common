...
namespace Dune {
  namespace TypeTree {
     ...
     *
     * \code
     * template<class Node, class Child, class TreePath>
     * struct VisitChild
     * {
    ...
    struct DefaultPairVisitor
    {
       ...
       */
      template<class T1, class Child1, class T2, class Child2, class TreePath, class ChildIndex>
